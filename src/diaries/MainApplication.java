...
public class MainApplication {
    ...
    private static void createDiary() {
        ...
        while(userName.matches("^[a-zA-Z]{1,3}$")){
            JOptionPane.showMessageDialog(null, "Invalid input. User name should contain only alphabets and " +
                    " and not be up to 50 characters long.");
